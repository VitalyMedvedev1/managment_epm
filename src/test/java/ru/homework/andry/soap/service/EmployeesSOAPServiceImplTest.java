...
//        List<EmployeeResponseBuilder> employeeResponseBuilders =
//                Arrays.asList(
//                        new GetEmployeeResponseBuilder(employeeSwitcherMapper),
//                        new CreateEmployeeResponseBuilder(employeeSwitcherMapper));
//
//
//        EmployeeResponseBuilder get = employeeResponseBuilders.stream()
//                .filter(rb -> rb.getClass().getSimpleName().startsWith("Get"))
//                .findFirst().orElseThrow();
//
//        EmployeeResponseBuilder create = employeeResponseBuilders.stream()
//                .filter(rb -> rb.getClass().getSimpleName().startsWith("Create"))
//                .findFirst().orElseThrow();
//
